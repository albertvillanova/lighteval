...
NO_ACCELERATE_ERROR_MSG = "You requested the use of accelerate for this evaluation, but it is not available in your current environment. Please install it using pip."
...
NO_TGI_ERROR_MSG = "You are trying to start a text generation inference endpoint, but text-generation is not present in your local environment. Please install it using pip."
...
NO_NANOTRON_ERROR_MSG = "You requested the use of nanotron for this evaluation, but it is not available in your current environment. Please install it using pip."
...
NO_BNB_ERROR_MSG = "You are trying to load a model quantized with `bitsandbytes`, which is not available in your local environment. Please install it using pip."
...
NO_AUTOGPTQ_ERROR_MSG = "You are trying to load a model quantized with `auto-gptq`, which is not available in your local environment. Please install it using pip."
...
NO_TORCH_ERROR_MSG = (
    "You are trying to use a `torch`, which is not available in your environment. Please install it using pip."
)
